public class teste{
    public static void main(String[] args) {
        ...
        // String[] urls_esc = escala.ESCALONA_TUDO_PROF();
        // String[] urls_esc = escala.ESCALONA_PROF(3);
        // String[] urls_esc = escala.ESCALONA_TUDO_LARG();
        // String[] urls_esc = escala.ESCALONA_LARG(3);
        // String[] urls_esc = escala.ESCALONA_TUDO_BEST();
        // String[] urls_esc = escala.ESCALONA_BEST(5);
    }
}
